...
// Replace the fixed bottom-[56px] with exact user classes except modifying bottom-0 to bottom-[56px] so it actually shows up
...
console.log("Fixed sticky bottom 2");
