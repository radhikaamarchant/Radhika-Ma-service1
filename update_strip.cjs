...
const newHeader = `{selectedBusiness && (
                <div className="px-4 pb-4">
                  <div className="flex items-center px-4 py-3.5 bg-white dark:bg-[#2B3648] overflow-x-auto hide-scrollbar shadow-sm">
...
if (code.includes(targetHeader)) {
  ...
  console.log('Successfully updated mobile strip!');
} else {
