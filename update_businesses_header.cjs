...
const oldHeader = `<div className="px-3 md:px-4 pt-2 md:pt-4 pb-2 md:pb-4 flex flex-col md:flex-row md:justify-between md:items-center relative mb-1 md:mb-0 bg-white dark:bg-kite-bg">`;
const newHeaderDesktop = `<div className="hidden md:flex px-4 pt-4 pb-4 flex-row justify-between items-center relative mb-0 bg-white dark:bg-kite-bg">`;
...
// we need to put mobileHeader right above the desktop header
...
console.log('Successfully updated Businesses header!');
