...
// Update BioRenderer mention click handling (if it exists here)
// Actually in Investors.tsx we don't have BioRenderer directly, we have InvestorPreviewModal.
// Wait, is there BioRenderer in Investors.tsx?
// No, Investors.tsx renders the list of investors, and when you click the image it opens InvestorPreviewModal.
