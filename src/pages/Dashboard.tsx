...
const topBusinesses = [...state.businesses] .sort((a, b) => b.interestRate - a.interestRate) .filter(b => b.name.toLowerCase().includes(searchTerm.toLowerCase()) || b.ownerName.toLowerCase().includes(searchTerm.toLowerCase())); 
